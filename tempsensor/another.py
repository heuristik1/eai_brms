...
print "Temperature-V1: %s Celsius" %temperature(r6,r7)
print "Temperature-V2: %s Celsius" %temperature(r8,r9)
print "Temperature-V3: %s Celsius" %temperature(ra,rb)
print "Temperature-V4: %s Celsius" %temperature(rc,rd)
